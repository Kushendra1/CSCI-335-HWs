...
//CSCI 335
//Professor Raja
//Assignment r Question 2 Part B

/*Parses the database and construct a search tree and does the following 4 tasks:
2. Prints the number of nodes in your tree n.

3. Computes the average depth of your search tree
a. Prints the average depth.
b. Prints the ratio of the average depth to log base 2 of the amount of nodes in tree
...
b. Prints the average number of recursion calls
...
6. Repeat of steps 2 and 3

Each task has a label corresponding to the numbers laid out in this comment */
